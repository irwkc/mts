...
_IMAGE_EDIT_FOLLOWUP = re.compile(
    ...
    # «добавь лису», «добавь ещё слона» — доработка сцены (не «добавь пункт/ссылку» в документ)
    r"добавь\s+(?:ещё|еще\s+)?(?!(?:пункт|ссылку|текст|заголовок|абзац|строку|файл|запись|комментарий)\b)[\wа-яё\-]{2,}|"
